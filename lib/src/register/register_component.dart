...
class RegisterComponent implements OnActivate, OnDeactivate {
  ...
  String get _nameUsed => Intl.message(
      'Dieser Name ist leider schon vergeben, bitte probiere einen anderen.',
      name: '_nameUsed',
      desc: 'Notification to be shown if entered name is already used');
  ...
  String get _forbiddenCharacters => Intl.message(
      ...
      desc:
          'Notification to be shown if username contains forbidden characters');

  String get _serverError => Intl.message(
      'Serverfehler - Bitte probiere es in einem Moment erneut.',
      name: '_serverError',
      desc: 'Notification to be shown if app receives a server error (500)');

  String get _timeout => Intl.message(
  ...
  String get _passwordMismatch => Intl.message(
      'Die angegebenen Passwörter stimmen nicht überein',
      name: '_passwordMismatch',
      desc:
          'Notification to be shown if the password confirmation on register page fails');

  String get _nameShort => Intl.message('Der Name ist zu kurz',
      name: '_nameShort',
      desc:
          'Notification to be shown if the name to be registered is too short');

  String get _passwordShort => Intl.message('Das Passwort ist zu kurz',
      name: '_passwordShort',
      desc: 'Notification to be shown if password is too short');

  String get _registrationSubmitted =>
      Intl.message('Registrierung wurde abgeschickt...',
